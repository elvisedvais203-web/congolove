...
export default function PrivacyPage() {
  return (
    <section className="space-y-5 animate-fade-in">
      <SectionHeader title="Politique de confidentialite" accent="violet" />
      <article className="glass neon-border-violet rounded-3xl p-5 text-sm text-slate-300 space-y-4">
        ...
        <p>Vous pouvez demander acces, rectification, suppression ou export de vos donnees via l equipe support.</p>
      </article>
    </section>
  );
}
