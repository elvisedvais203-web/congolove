...
export default function TermsPage() {
  return (
    <section className="space-y-5 animate-fade-in">
      <SectionHeader title="Conditions d utilisation" accent="gold" />
      <article className="glass neon-border-gold rounded-3xl p-5 text-sm text-slate-300 space-y-4">
        <p>En utilisant Solola, vous acceptez de respecter les regles de conduite, la legislation en vigueur et les politiques de moderation.</p>
        ...
        <p>Les offres Premium sont facturees selon le tarif affiche. Les demandes de remboursement sont traitees par l equipe support selon le contexte du paiement.</p>
        <h3 className="font-heading text-white text-base">4. Responsabilites</h3>
        <p>Solola fournit une plateforme de mise en relation et ne garantit pas un resultat sentimental. Les utilisateurs restent responsables de leurs rencontres et decisions.</p>
      </article>
    </section>
  );
}
