...
const stats = [
  ...
  { value: "98%", label: "Taux de securite", color: "green" },
  ...
  return (
    <section className="space-y-8 animate-fade-in">
      ...
      <div className="glass neon-border rounded-4xl p-6 text-center">
        <p className="font-heading text-2xl font-bold text-white mb-2">Rejoignez KongoLove</p>
        <p className="text-sm text-slate-400 max-w-md mx-auto mb-5">Plus de 50 000 personnes ont deja trouve leur connexion. Votre histoire commence ici.</p>
