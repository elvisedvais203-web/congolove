...
import { adminGuard, superAdminGuard } from "../middleware/nextalkadmin";
...
router.post("/admin/users/:userId/restriction", authGuard, superAdminGuard, csrfGuard, updateAccountRestriction);
...
router.post("/admin/users/:userId/review-verification", authGuard, superAdminGuard, csrfGuard, reviewVerification);
